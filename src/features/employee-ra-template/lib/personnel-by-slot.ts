import { makeSlotKey } from '@/features/employee-ra-template/lib/slot-key';
import type {
  EmployeeRATemplate,
  EmployeeRATemplateItem,
} from '@/features/employee-ra-template/types';
import type { MergedTimetableItem } from '@/features/timetable-template/types';
