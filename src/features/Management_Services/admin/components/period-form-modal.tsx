...
import { useCreatePeriod, useUpdatePeriod } from '@/features/Management_Services/admin';
import type {
  ReqCreatePeriodDTO,
  ReqUpdatePeriodDTO,
  ResPeriodDTO,
...
import { useTimetableTemplatesQuery } from '@/features/Management_Services/timetable-template';
