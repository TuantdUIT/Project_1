...
import { useDeletePeriod, usePeriodsByUserQuery } from '@/features/Management_Services/admin';
import type { ResPeriodDTO, TuitionStatus } from '@/features/Management_Services/admin/types';
