...
import { buildTimetableLayout } from '@/features/Management_Services/timetable-template/lib/layout';
import {
  COMPACT_HOUR_HEIGHT_PX,
  DAY_OF_WEEK_ORDER,
  HOUR_HEIGHT_PX,
} from '@/features/Management_Services/timetable-template/lib/time';
import type { LessonType, MergedTimetableItem } from '@/features/Management_Services/timetable-template/types';
