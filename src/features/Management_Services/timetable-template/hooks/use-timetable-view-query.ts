...
} from '@/features/Management_Services/employee-ra-template';
import { attachPersonnelToTimetableItems } from '@/features/Management_Services/employee-ra-template/lib/personnel-by-slot';
import { getTemplateByGradeId } from '@/features/Management_Services/timetable-template/api/templates';
import {
  mergeItemsForPrimary,
  type TemplatesByGradeId,
} from '@/features/Management_Services/timetable-template/lib/merge-supplement';
import {
  GRADE_BADGE_BY_ID,
