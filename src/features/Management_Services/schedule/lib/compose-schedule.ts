...
import type { StudyWeek } from '@/features/Management_Services/study-week';
import type { TimetableTemplate } from '@/features/Management_Services/schedule/api/timetable-templates';
